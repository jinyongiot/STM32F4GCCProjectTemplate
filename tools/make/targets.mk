...
VTMPL_COMMAND=$(PYTHON) $(PROJECT_BASE)/tools/make/versionTemplate.py --project-base $(PROJECT_BASE) $< $@
#$(BIN)/$(lastword $(subst /, ,$@))
...
DFU_COMMAND=$(PYTHON) $(PROJECT_BASE)/tools/make/dfu-convert.py -b $(LOAD_ADDRESS):$< $@
...
MRPROPER_COMMAND=rm -f *~ utils/src/*~ utils/inc/*~ tools/make/*~; rm -rf bin/dep/*.d $(BIN)/*.a
